...
export const getTopModels = async (token: string, start: string, end: string) => {
	...
	const res = await fetch(
		`${WEBUI_API_BASE_URL}/analytics/top-models?start_date=${start}&end_date=${end}`,
		{
			method: 'GET',
			headers: {
...
export const getTopUsers = async (token: string, start: string, end: string) => {
	...
	const res = await fetch(
		`${WEBUI_API_BASE_URL}/analytics/top-users?start_date=${start}&end_date=${end}`,
		{
			method: 'GET',
			headers: {
				'Content-Type': 'application/json',
...
export const getTopAssistants = async (token: string, start: string, end: string) => {
	let error = null;

	const res = await fetch(
		`${WEBUI_API_BASE_URL}/analytics/top-assistants?start_date=${start}&end_date=${end}`,
		{
			method: 'GET',
			headers: {
				'Content-Type': 'application/json',
