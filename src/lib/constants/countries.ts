...
/**
 * ISO 3166-1 alpha-2 country list with dial codes and flag emojis.
...
export const COUNTRIES: Country[] = [
	...
	{ name: 'Curaçao', iso: 'CW', dialCode: '+599', flag: '🇨🇼' },
	...
	{ name: 'Macao', iso: 'MO', dialCode: '+853', flag: '🇲🇴' },
...
export function getDefaultCountry(): Country {
	return findCountryByIso(DEFAULT_ISO)!;
}
