...
<div>
	...
	>
		...
		{#if showDropdown}
			<div
				class="w-[10rem] flex flex-col absolute md:left-0 right-0 bg-lightGray-300 border-lightGray-400 dark:bg-customGray-900 px-1 py-2 border dark:border-customGray-700 rounded-lg z-10"
			>
				{#if (inviteCompleted)}
					<button
						type="button"
