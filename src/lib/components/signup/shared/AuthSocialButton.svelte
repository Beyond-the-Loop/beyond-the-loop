<script lang="ts">
	...
	export let provider: 'google' | 'microsoft';
...
>
	...
	{:else}
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 21" class="h-5 w-5 shrink-0">
	...
	{/if}
	<span>{provider === 'google' ? $i18n.t('Continue with Google') : $i18n.t('Continue with Microsoft')}</span>
</button>
