...
async def invite_user(form_data: UserInviteForm, user=Depends(get_admin_user)):
    ...
    try:
        ...
        for invitee in form_data.invitees:
            ...
            COMPANIES_ALLOWED_NON_BUSINESS_EMAILS = {"1f62d141-5b4f-4ebf-8468-83bab4765c1b", "bed374b4-bd32-42f6-8cd0-0767bbe7fdc5", "bdc018de-359c-480b-aa44-b7d9c47a5b4c", "8c67a57e-618d-4bc7-8577-a5b65227a43b", "4a57b114-b3e9-4d83-8670-f0962f3be42e"}
